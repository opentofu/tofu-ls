...
//go:generate go tool golang.org/x/tools/cmd/stringer -type=OpState -output=op_state_string.go
type OpState uint
...
//go:generate go tool golang.org/x/tools/cmd/stringer -type=OpType -output=op_type_string.go
type OpType uint
